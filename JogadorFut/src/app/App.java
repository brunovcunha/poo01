...
public class App {
    ...
    public static JogadorDeFutebol leDados() {
        ...
        s.nextLine();
        System.out.println("Nascionalidade do Jogador: ");
        String nascionalidade = s.nextLine();
        System.out.println("Posicao do Jogador: ");
        String posicao = s.nextLine();

        JogadorDeFutebol jogador = new JogadorDeFutebol(nome, nascimento, altura, peso, nascionalidade, posicao);
